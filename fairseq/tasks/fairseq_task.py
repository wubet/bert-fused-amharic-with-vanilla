...
class FairseqTask(object):
    ...
    def __init__(self, args=None, cfg=None):
        if cfg is not None:
            ...
            raise ValueError("Either args or cfg must be provided to FairseqTask")
        self.datasets = {}
    ...
    def get_batch_iterator(
            ...
            seed=1, num_shards=1, shard_id=0, num_workers=0, epoch=0, data_buffer_size=0,
            disable_iterator_cache=False, skip_remainder_batch=False, grouped_shuffling=False,
        ...
        if rebuild_batches:
            ...
            batch_samplers = make_batches
        else:
            batch_samplers = make_batches(dataset, epoch)
    ...
    def train_bert_step(self, sample, model, criterion, optimizer, ignore_grad=False):
        """
