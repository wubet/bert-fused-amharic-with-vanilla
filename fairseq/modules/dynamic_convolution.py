...
class DynamicConv1dTBC(nn.Module):
    ...
    def _get_input_buffer(self, incremental_state):
        return utils_bert.get_incremental_state(self, incremental_state, 'input_buffer')

    def _set_input_buffer(self, incremental_state, new_buffer):
        return utils_bert.set_incremental_state(self, incremental_state, 'input_buffer', new_buffer)
