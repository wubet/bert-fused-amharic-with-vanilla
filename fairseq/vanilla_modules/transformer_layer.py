...
# from fairseq.vanilla_modules import VanillaMultiheadAttention
from fairseq.vanilla_modules.fairseq_dropout import FairseqDropout
from fairseq.vanilla_modules.quant_noise import quant_noise
from fairseq.vanilla_modules.vanilla_multihead_attention import VanillaMultiheadAttention
...
class TransformerEncoderLayerBase(nn.Module):
    ...
    *cfg.encoder.normalize_before* to ``True``.
    ...
    def build_self_attention(self, embed_dim, cfg):
        return VanillaMultiheadAttention(
            embed_dim,
