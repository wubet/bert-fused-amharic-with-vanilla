...
class LSTMModel(FairseqEncoderDecoderModel):
    ...
    def build_model(cls, args, task):
        ...
        def load_pretrained_embedding_from_file(embed_path, dictionary, embed_dim):
            ...
            embed_dict = utils_bert.parse_embedding(embed_path)
            utils_bert.print_embed_overlap(embed_dict, dictionary)
            return utils_bert.load_embedding(embed_dict, dictionary, embed_tokens)
...
class LSTMDecoder(FairseqIncrementalDecoder):
    ...
    def forward(self, prev_output_tokens, encoder_out, incremental_state=None):
        ...
        cached_state = utils_bert.get_incremental_state(self, incremental_state, 'cached_state')
        ...
        utils_bert.set_incremental_state(
    ...
    def reorder_incremental_state(self, incremental_state, new_order):
        ...
        utils_bert.set_incremental_state(self, incremental_state, 'cached_state', new_state)
