...
from . import FairseqDataset, FastaDataset
from ..dataclass.constants import DATASET_IMPL_CHOICES
...
class MMapIndexedDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, i):
        ...
        numpy_array = np.frombuffer(self._bin_buffer, dtype=self._index.dtype, count=size, offset=ptr)

        # Check if the numpy array is writable, and if not, make a copy
