...
from .vanilla_fairseq_decoder import FairseqDecoder
from .vanilla_fairseq_encoder import FairseqEncoder
from .vanilla_fairseq_model import (
    BaseFairseqModel,
...
import_models(models_dir, "fairseq.vanilla_models")
