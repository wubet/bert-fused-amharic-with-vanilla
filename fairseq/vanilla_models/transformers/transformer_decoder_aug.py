...
from fairseq.vanila_models.transformer import TransformerConfig
from fairseq.vanila_models.transformer.transformer_decoder import TransformerDecoderBase
