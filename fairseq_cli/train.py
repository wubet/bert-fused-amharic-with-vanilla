...
from fairseq.vanilla_trainer import VanillaTrainer
...
def main(cfg: FairseqConfig) -> None:
    ...
    if cfg.common.model_parallel_size == 1:
        trainer = VanillaTrainer(cfg, task, model, criterion, quantizer)
    else:
...
def train(
    cfg: DictConfig, trainer: VanillaTrainer, task: tasks.FairseqTask, epoch_itr
...
def cli_main(
    ...
    parser = options.get_training_parser(is_vanilla=True)
